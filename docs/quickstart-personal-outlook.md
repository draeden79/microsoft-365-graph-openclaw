...
Para o **fluxo mínimo em 6 passos** (menos parâmetros), ver [Guia mínimo](guia-minimo.md).

## Target

Use this skill with personal Microsoft accounts (for example Outlook.com/Hotmail) in a self-hosted OpenClaw setup.
...
- In the minimal flow, `GRAPH_WEBHOOK_CLIENT_STATE` is auto-generated by the e2e setup script
